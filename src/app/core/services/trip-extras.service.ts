...
export class TripExtrasService {
  private extras: TripExtra[] = [
    ...
    {
      extrasId: 2,
      extrasName: 'First Class Upgrade',
      extrasquantity: 0,
      extrasPrice: 100,
    },
    {
      extrasId: 3,
      extrasName: 'Extra Luggage',
      extrasquantity: 0,
      extrasPrice: 150,
    },
    ...
    {
      extrasId: 6,
      extrasName: 'Extra Legroom',
      extrasquantity: 0,
      extrasPrice: 40,
    },
    {
      extrasId: 7,
      extrasName: 'Insurance',
      extrasquantity: 0,
      extrasPrice: 60,
    },
    {
    ...
    switch (type.toLowerCase()) {
      case 'flight':
        return this.extras.filter((extra) =>
          ['Meal', 'First Class Upgrade', 'Extra Luggage'].includes(
            extra.extrasName
          )
        );
      case 'train':
        return this.extras.filter((extra) =>
          ['Meal', 'First Class Upgrade', 'WiFi'].includes(extra.extrasName)
        );
      case 'bus':
        return this.extras.filter((extra) =>
          ['WiFi', 'AC', 'Extra Legroom'].includes(extra.extrasName)
        );
      default:
        return this.extras;
    }
